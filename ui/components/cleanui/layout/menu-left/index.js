...
;(function($) {
  ...
  $(function() {
    ...
    if(localStorage.getItem('menu_toggled') == 1)
      $('body').addClass('cui__menuLeft--toggled');
    else
      $('body').removeClass('cui__menuLeft--toggled');
    ...
    var saveToggle = function() {
      if($('body').hasClass('cui__menuLeft--toggled'))
        localStorage.setItem('menu_toggled', 1);
      else
        localStorage.setItem('menu_toggled', 0);
    }
    ...
    $('.cui__menuLeft__trigger').on('click', function() {
      ...
      saveToggle();
      // if($('body').hasClass('cui__menuLeft--toggled'))
      //   localStorage.setItem('menu_state', 'toggled');
      // else
