...
*   NEW: Added SameSite cookie support for php7.3+ (JAR.samesite), [bcosca/fatfree#1165](../index.phphub.com/bcosca/fatfree/issues/1165)
*   NEW, DB\SQL\Mapper: added updateAll method to batch-update multiple records at once
*   CHANGED, DB\SQL\Mapper: Throw error on update/erase if the table has no primary key, [#285](../index.phphub.com/bcosca/fatfree-core/issues/285)
*   Cache, Redis: Added ability to set a Redis password, [#287](../index.phphub.com/bcosca/fatfree-core/issues/287)
*   DB\SQL\Session: make datatype of data column configurable, [bcosca/fatfree#1130](../index.phphub.com/bcosca/fatfree/issues/1130)
*   DB\SQL\Mapper: only add adhoc fields in count queries that are used for grouping
*   DB\SQL\Mapper: fixed inserting an already loaded record again (duplicating), [bcosca/fatfree#1093](../index.phphub.com/bcosca/fatfree/issues/1093)
*   Magic (Mappers): fix isset check on existing properties
*   SMTP: added support for Bounce mail recipient ("Sender" header)
*   OAuth2: make query string encode type configurable, [#268](../index.phphub.com/bcosca/fatfree-core/issues/268) [#269](../index.phphub.com/bcosca/fatfree-core/issues/269)
*   Web: Added more cyrillic letters to diacritics, [bcosca/fatfree#1158](../index.phphub.com/bcosca/fatfree/issues/1158)
*   Web: Fixed url string falsely detected as comment section [9ac8e615](../index.phphub.com/bcosca/fatfree-core/commit/9ac8e615ccaf750b49497a3c86161331b24e637f)
*   Web: added file inspection for mime-type detection, [#270](../index.phphub.com/bcosca/fatfree-core/issues/270), [bcosca/fatfree#1138](../index.phphub.com/bcosca/fatfree/issues/1138)
*   WS: Fixed processing all queued data frames inside the buffer, [#277](../index.phphub.com/bcosca/fatfree-core/issues/277)
*   WS: Allow packet size override
*   Markdown: Support mixed `strong` and `italic` elements, [#276](../index.phphub.com/bcosca/fatfree-core/issues/276)
*   Markdown: Keep spaces around `=` sign in ini code blocks 
*   Added route alias key name validation, [#243](../index.phphub.com/bcosca/fatfree-core/issues/243)
*   Added fragment argument to alias method, [#282](../index.phphub.com/bcosca/fatfree-core/issues/282)
*   Allow adding fragment to reroute, [#1156](../index.phphub.com/bcosca/fatfree/issues/1156)
*   Added additional HTTP status codes, [#283](../index.phphub.com/bcosca/fatfree-core/issues/283)
*   Added X-Forwarded-For IP to log entries, [bcosca/fatfree#1042](../index.phphub.com/bcosca/fatfree/issues/1042)
*   Bug fix: broken custom date/time formatting, [bcosca/fatfree#1147](../index.phphub.com/bcosca/fatfree/issues/1147)
*   Bug fix: duplicate UI path rendering edge-case in Views and minify, [bcosca/fatfree#1152](../index.phphub.com/bcosca/fatfree/issues/1152)
*   Bug fix: unicode chars in custom config section keys, [bcosca/fatfree#1149](../index.phphub.com/bcosca/fatfree/issues/1149)
*   Bug fix: ensure valid reroute path in location header, [bcosca/fatfree#1140](../index.phphub.com/bcosca/fatfree/issues/1140)
*   Bug fix: use dictionary path for lexicon caching-hash
*   Bug fix, php7.3: number format ternary, [bcosca/fatfree#1142](../index.phphub.com/bcosca/fatfree/issues/1142)
*   fix PHPdoc and variable inspection, [bcosca/fatfree#865](../index.phphub.com/bcosca/fatfree/issues/865), [bcosca/fatfree#1128](../index.phphub.com/bcosca/fatfree/issues/1128)

3.6.5 (24 December 2018)
*	NEW: Log, added timestamp to each line
*	NEW: Auth, added support for custom compare method, [#116](../index.phphub.com/bcosca/fatfree-core/issues/116)
*	NEW: cache tag support for mongo & jig mapper, ref [#166](../index.phphub.com/bcosca/fatfree-core/issues/116)
...
*	Web\OAuth2: take Content-Type header into account for json decoding, [#250](../index.phphub.com/bcosca/fatfree-core/issues/250) [#251](../index.phphub.com/bcosca/fatfree-core/issues/251)
*	Web\OAuth2: fixed empty results on some endpoints [#250](../index.phphub.com/bcosca/fatfree-core/issues/250)
*	DB\SQL\Mapper: optimize mapper->count memory usage
*	DB\SQL\Mapper: New table alias operator
*	DB\SQL\Mapper: fix count() performance on non-grouped result sets, [bcosca/fatfree#1114](../index.phphub.com/bcosca/fatfree/issues/1114)
*	DB\SQL: Support for CTE in postgreSQL, [bcosca/fatfree#1107](../index.phphub.com/bcosca/fatfree/issues/1107), [bcosca/fatfree#1116](../index.phphub.com/bcosca/fatfree/issues/1116), [bcosca/fatfree#1021](../index.phphub.com/bcosca/fatfree/issues/1021)
...
*	Basket: Access basket item by _id [#260](../index.phphub.com/bcosca/fatfree-core/issues/260)
*	SMTP: Added TLS 1.2 support [bcosca/fatfree#1115](../index.phphub.com/bcosca/fatfree/issues/1115)
...
*	Enable route handler to override Access-Control headers in response to OPTIONS request, [#257](../index.phphub.com/bcosca/fatfree-core/issues/257)
...
*	Bug fix: Method uppercase to avoid route failure [#252](../index.phphub.com/bcosca/fatfree-core/issues/252)
*	Fixed error description when (PSR-11) `CONTAINER` fails to resolve a class [#253](../index.phphub.com/bcosca/fatfree-core/issues/253)
*	Mitigate CSRF predictability/vulnerability
*	Expose Mapper->factory() method

3.6.4 (19 April 2018)
*	NEW: Added Dependency Injection support with CONTAINER variable [#221](../index.phphub.com/bcosca/fatfree-core/issues/221)
*	NEW: configurable LOGGABLE error codes [#1091](../index.phphub.com/bcosca/fatfree/issues/1091#issuecomment-364674701)
*	NEW: JAR.lifetime option, [#178](../index.phphub.com/bcosca/fatfree-core/issues/178)
*	Template: reduced Prefab calls
*	Template: optimized reflection for better derivative support, [bcosca/fatfree#1088](../index.phphub.com/bcosca/fatfree/issues/1088)
*	Template: optimized parsing for template attributes and tokens
*	DB\Mongo: fixed logging with mongodb extention
*	DB\Jig: added lazy-loading [#7e1cd9b9b89](../index.phphub.com/bcosca/fatfree-core/commit/7e1cd9b9b89c4175d0f6b86ced9d9bd49c04ac39)
*	DB\Jig\Mapper: Added group feature, bcosca/fatfree#616
*	DB\SQL\Mapper: fix PostgreSQL RETURNING ID when no pkey is available, [bcosca/fatfree#1069](../index.phphub.com/bcosca/fatfree/issues/1069), [#230](../index.phphub.com/bcosca/fatfree-core/issues/230)
*	DB\SQL\Mapper: disable order clause auto-quoting when it's already been quoted
*	Web->location: add failsafe for geoip_region_name_by_code() [#GB:Bxyn9xn9AgAJ](../index.phpups.google.com/d/msg/f3-framework/APau4wnwNzE/Bxyn9xn9AgAJ)
*	Web->request: Added proxy support [#e936361b](../index.phphub.com/bcosca/fatfree-core/commit/e936361bc03010c4c7c38a396562e5e96a8a100d)
*	Web->mime: Added JFIF format
*	Markdown: handle line breaks in paragraph blocks, [bcosca/fatfree#1100](../index.phphub.com/bcosca/fatfree/issues/1100)
*	config: reduced cast calls on parsing config sections
*	Patch empty SERVER_NAME [bcosca/fatfree#1084](../index.phphub.com/bcosca/fatfree/issues/1084)
*	Bugfix: unreliable request headers in Web->request() response [bcosca/fatfree#1092](../index.phphub.com/bcosca/fatfree/issues/1092)
*	Fixed, View->render: utilizing multiple UI paths, [bcosca/fatfree#1083](../index.phphub.com/bcosca/fatfree/issues/1083)
*	Fixed URL parsing with PHP 5.4 [#247](../index.phphub.com/bcosca/fatfree-core/issues/247)
*	Fixed PHP 7.2 warnings when session is active prematurely, [#238](../index.phphub.com/bcosca/fatfree-core/issues/238)
*	Fixed setcookie $expire variable type [#240](../index.phphub.com/bcosca/fatfree-core/issues/240)
...
*	SMTP: clean-up mail headers for multipart messages, [#1065](../index.phphub.com/bcosca/fatfree/issues/1065)
*	config: fixed performance issues on parsing config files
*	config: cast command parameters in config entries to php type & constant, [#1030](../index.phphub.com/bcosca/fatfree/issues/1030)
*	config: reduced registry calls
*	config: skip hive escaping when resolving dynamic config vars, [#1030](../index.phphub.com/bcosca/fatfree/issues/1030)
*	Bug fix: Incorrect cookie lifetime computation, [#1070](../index.phphub.com/bcosca/fatfree/issues/1070), [#1016](../index.phphub.com/bcosca/fatfree/issues/1016)
*	DB\SQL\Mapper: use RETURNING option instead of a sequence query to get lastInsertId in PostgreSQL, [#1069](../index.phphub.com/bcosca/fatfree/issues/1069), [#230](../index.phphub.com/bcosca/fatfree-core/issues/230)
*	DB\SQL\Session: check if _agent is too long for SQL based sessions [#236](../index.phphub.com/bcosca/fatfree-core/issues/236)
*	DB\SQL\Session: fix Session handler table creation issue on SQL Server, [#899](../index.phphub.com/bcosca/fatfree/issues/899)
*	DB\SQL: fix oracle db issue with empty error variable, [#1072](../index.phphub.com/bcosca/fatfree/issues/1072)
*	DB\SQL\Mapper: fix sorting issues on SQL Server, [#1052](../index.phphub.com/bcosca/fatfree/issues/1052) [#225](../index.phphub.com/bcosca/fatfree-core/issues/225)
*	Prevent directory traversal attacks on filesystem based cache [#1073](../index.phphub.com/bcosca/fatfree/issues/1073)
*	Bug fix, Template: PHP constants used in include with attribute, [#983](../index.phphub.com/bcosca/fatfree/issues/983)
*	Bug fix, Template: Numeric value in expression alters PHP_EOL context
*	Template: use existing linefeed instead of PHP_EOL, [#1048](../index.phphub.com/bcosca/fatfree/issues/1048)
*	Template: make newline interpolation handling configurable [#223](../index.phphub.com/bcosca/fatfree-core/issues/223)
*	Template: add beforerender to Preview
*	fix custom FORMATS without modifiers
*	Cache: Refactor Cache->reset for XCache
*	Cache: loosen reset cache key pattern, [#1041](../index.phphub.com/bcosca/fatfree/issues/1041)
*	XCache: suffix reset only works if xcache.admin.enable_auth is disabled
*	Added HTTP 103 as recently approved by the IETF
*	LDAP changes to for AD flexibility [#227](../index.phphub.com/bcosca/fatfree-core/issues/227)
*	Hide debug trace from ajax errors when DEBUG=0 [#1071](../index.phphub.com/bcosca/fatfree/issues/1071)
*	fix View->render using potentially wrong cache entry

3.6.2 (26 June 2017)
*   Return a status code > 0 when dying on error [#220](../index.phphub.com/bcosca/fatfree-core/issues/220)
*   fix SMTP line width [#215](../index.phphub.com/bcosca/fatfree-core/issues/215)
*   Allow using a custom field for ldap user id checking [#217](../index.phphub.com/bcosca/fatfree-core/issues/217)
*   NEW: DB\SQL->exists: generic method to check if SQL table exists
*   Pass handler to route handler and hooks [#1035](../index.phphub.com/bcosca/fatfree/issues/1035)
*   pass carriage return of multiline dictionary keys
*   Better Web->slug customization
*   fix incorrect header issue [#211](../index.phphub.com/bcosca/fatfree-core/issues/211)
*   fix schema issue on databases with case-sensitive collation, fixes [#209](../index.phphub.com/bcosca/fatfree-core/issues/209)
...
*   fix php carriage return issue in preview->build [#205](../index.phphub.com/bcosca/fatfree-core/pull/205)
*   fixed template string resolution [#205](../index.phphub.com/bcosca/fatfree-core/pull/205)
*   Fixed unexpected default seed on CACHE set [#1028](../index.phphub.com/bcosca/fatfree/issues/1028)
*   DB\SQL\Mapper: Optimized field escaping on options
*   Optimize template conversion to PHP file

3.6.1 (2 April 2017)
*	NEW: Recaptcha plugin [#194](../index.phphub.com/bcosca/fatfree-core/pull/194)
*	NEW: MB variable for detecting multibyte support
*	NEW: DB\SQL: Cache parsed schema for the TTL duration
*	NEW: quick erase flag on Jig/Mongo/SQL mappers [#193](../index.phphub.com/bcosca/fatfree-core/pull/193)
*	NEW: Allow OPTIONS method to return a response body [#171](../index.phphub.com/bcosca/fatfree-core/pull/171)
*	NEW: Add support for Memcached (bcosca/fatfree#997)
*	NEW: Rudimentary preload resource (HTTP2 server) support via template push()
*	NEW: Add support for new MongoDB driver [#177](../index.phphub.com/bcosca/fatfree-core/pull/177)
...
*	Changed: count() method now has an options argument [#192](../index.phphub.com/bcosca/fatfree-core/pull/192)
...
*	Add option to debounce Cursor->paginate subset [#195](../index.phphub.com/bcosca/fatfree-core/pull/195)
